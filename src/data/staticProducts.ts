export const staticProducts = [
  ...
  },
  {
    ...
    price: 15.99,
    description: "The color could be slightly different between on the screen and in practice. Please note that body builds vary by person, therefore, detailed size information should be reviewed below on this page.",
    category: "men's clothing",
  ...
  },
  {
    ...
    price: 109,
    description: "Easy upgrade for faster boot up, shutdown, carrying, and loading files. Load applications, photos, videos and more instantly with up to 540 MB/s read speeds.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 114,
    description: "Expand your PS4 gaming experience; Play games from console; Plug and Play Storage; Compatibility Playstation 4.",
    category: "electronics",
  ...
  },
  {
    ...
    price: 999.99,
    description: "49 INCH SUPER ULTRAWIDE: Display is 32:9 ratio. 5120 x 1440 resolution with 144hz screen, Radeon free sync 2 and target prime HDR",
    category: "electronics",
  ...
  },
  {
    ...
    price: 29.95,
    description: "100% POLYURETHANE(PU); has a fantastic fit, a mini-qilted sandbag pattern on the back. The YKK front-zipper opens up to 18inches.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 39.99,
    description: "Lightweight perfect for trip or casual wear. Long sleeve with hooded, adjustable drawstring waist design. Button and zipper front closure.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 7.95,
    description: "100% Polyester; Machine wash, Do not wring Moisture wicking & 4-way stretch Downproof & MoistureResistant Fabric.",
    category: "women's clothing",
  ...
  },
  {
    ...
    price: 12.99,
    description: "95% COTTON, 5% SPANDEX. Made in USA or Imported. Machine wash and dry. Floral print. Casual summer top with T-shirt style.",
    category: "women's clothing",
